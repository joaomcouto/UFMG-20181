...
int main(int argc, char* argv[]){
    ...
    //short int Recseg[TamY][TamX] ;
    //short int Recimage[TamY][TamX] ;
    Init2D(TamY,TamX,seg) ;
    //Init2D(TamY,TamX,Recseg) ;
    LerPGM(pgm, TamX, TamY, image) ;
    //LerPGM(pgm, TamX, TamY, Recimage) ;
    ...
    /* Favor ler nota na secao conclusao da documentacao
    ...
    while(Visitados > 200 ){
        ...
        RecSegmenta(SementeRand.PosY, SementeRand.PosX, &Visitados, CorRand, T, TamX, TamY, Recimage, Recseg, RecRGB) ;
